...
Endpoints:
  POST /incoming-call     — Twilio webhook when someone calls
  WS   /ws/call/{sid}    — WebSocket audio stream for active calls
  GET  /health            — Health check
  GET  /calls             — List active calls (for dashboard)
  POST /test-agent        — Test the agent with text (no phone needed)
"""
